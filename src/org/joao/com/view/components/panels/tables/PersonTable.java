...
public class PersonTable extends PanelTable<Person> {
    ...
    public PersonTable(Person[] data) {
        super(data, new String[]{"Nombre", "Apellido", "Dirección", "Telefono", "Usuario", "Contraseña", "Usuario desde", "Sexo", "nacionalidad", "Numero de Documento", "Tipo de documento", "Compañia Telefonica"}, "Personas");
    }
    ...
    protected String[] dataToStringArr(Person person) {
        ...
        String dateCreation = person.getDateCreation();
